...
def create_card_phantasmal_killer(upgraded: CardUpgraded) -> EntityCard:
    if upgraded:
        return EntityCard(
            f"{_NAME}+",
            _COLOR,
            ...
            _COST_PLUS,
            _RARITY,
            [Effect(EffectType.MODIFIER_PHANTASMAL_GAIN, 1, EffectTargetType.CHARACTER)],
        )
