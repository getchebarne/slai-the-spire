...
_COST = 1
_ACCURACY_STACKS_GAIN = 4
_ACCURACY_STACKS_GAIN_PLUS = 6
_RARITY = CardRarity.UNCOMMON
_TYPE = CardType.POWER


@register_factory(_NAME)
def create_card_accuracy(upgraded: CardUpgraded) -> EntityCard:
    if upgraded:
        return EntityCard(
            f"{_NAME}+",
            _COLOR,
            ...
            [
                Effect(
                    EffectType.MODIFIER_ACCURACY_GAIN,
                    _ACCURACY_STACKS_GAIN_PLUS,
