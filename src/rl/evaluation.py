...
from src.game.combat.entities import add_entity
...
def _eval_blunder(policy: PolicyBase) -> bool:
    ...
    id_strike = add_entity(cs.entity_manager, create_strike())
...
def _eval_lethal(policy: PolicyBase) -> bool:
    ...
    cs.entity_manager.id_cards_in_hand = [
        add_entity(cs.entity_manager, create_strike()),
        add_entity(cs.entity_manager, create_strike()),
        add_entity(cs.entity_manager, create_strike()),
        add_entity(cs.entity_manager, create_defend()),
        add_entity(cs.entity_manager, create_defend()),
    ]
...
def _eval_draw_first_w_backflip(policy: PolicyBase) -> bool:
    ...
    # Create a Backflip
    id_backflip = add_entity(cs.entity_manager, create_backflip())
...
def _eval_dagger_throw_vs_strike(policy: PolicyBase) -> bool:
    ...
    id_dagger_throw = add_entity(cs.entity_manager, create_dagger_throw())
